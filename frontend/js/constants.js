const contractAddress = "0x74cd95161c1060C6D091fCFDB4eCC2A112f8905a"; //Replace with your own contract address
const chain = 'rinkeby'; // rinkeby or polygon

const welcome_h1 = "Welcome to our harbour";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'Gather your flock of strange piranhas';
...
const p_presale_mint_not_whitelisted = "Sorry, You are not whitelisted for the pre-sale...";
...
const button_presale_already_minted = "Join The flock";
const button_public_mint = "Mint Your Piranha. Aghrrr!!!";
